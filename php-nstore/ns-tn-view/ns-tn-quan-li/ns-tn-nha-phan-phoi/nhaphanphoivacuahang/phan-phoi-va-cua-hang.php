<?php
        ...
        ?>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center">
                ...
                <div class="text-center">
                    <h3><strong><b>Quản Lí Nhà Phân Phối Và Cửa Hàng</b></strong></h3>
                </div>
            </div>  <!-- END TITLE -->
            ...
            <div class="">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex justify-content-start mt-3">
                        <a class="btn btn-outline-brown dangxuat rounded-pill ml-3" href="index.php?page=quanlinhaphanphoi">Trở Về</a>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <input type="text" id="tenkhachtim" onkeyup="TimKhachHangCoCuaHang()" class="form-control rounded-pill">
                            </div>    
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <label for=""><b>Nhập số điện thoại: </b></label>
                                <input type="number" id="sodienthoaikhachtim" onkeyup="TimKhachHangCoCuaHang()" class="form-control rounded-pill">
                            </div>  
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <label for=""><b>Chứng minh nhân dân: </b></label>
                                <input type="number" id="cmnd" onkeyup="TimKhachHangCoCuaHang()" class="form-control rounded-pill">
                            </div>
                        </div>           
                    </div>
                </div>  <!-- END TIM KIEM -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-3">
                ...
                <div class="table-responsive-lg" id="bangloc">
                    ...
                    <table class="table table-hover table-bordered table-sm table-light text-center mb-3">
                        <thead>
                            <tr>
                                <th scope="col" colspan="8">TẤT CẢ NHÀ PHÂN PHỐI CÓ CỬA HÀNG</th>
                            </tr>
                        ...
                        <?php
                            ...
                            $thongtin = $nhaphanphoi->NhaPhanPhoiCoCuaHang();
                            $stt = 1;
    ...
    require "ns-tn-view/ns-tn-quan-li/ns-tn-nha-phan-phoi/modal/modal-xem-thong-tin.php"
?>
